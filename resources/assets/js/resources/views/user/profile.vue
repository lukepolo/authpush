            ...
            <div class="col-md-12 text-center">
                ...
                <modal v-if="showDeleteAccountModal">
                    ...
                    <div class="custom-modal--body">
                        <p>
                            Are you sure you want to delete your AuthPush account? This action is <strong>permanent</strong> and can not be undone.
                        </p>
                    </div>
                    <div class="custom-modal--footer">
                        ...
                        <button type="button" class="s-button s-button-green" data-dismiss="modal" @click="showDeleteAccountModal = false">Cancel</button>
                    </div>
                </modal>
            </div>
        </div>
